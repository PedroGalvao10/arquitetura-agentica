...
import { AgenticWorkflowBlock } from '@/components/ui/n8n-workflow-block-shadcnui';
import { ContainerScroll } from '@/components/ui/container-scroll-animation';
import { AgenticImageCarousel } from '@/components/ui/agentic-image-carousel';
...
export function LandingPage() {
  ...
  return (
    ...
    <section className="hero-section" id="visao">
        <div className="hero-content">
            ...
            <div className="hero-subtitle text-center mx-auto max-w-3xl">
                <AppleRevealText 
    ...
    <section className="architecture-section" id="fluxo">
        ...
        <div className="layers-showcase">
            ...
            <div className="layer-card reveal" data-layer="1">
                ...
                <div className="layer-visual rounded-xl border border-white/5 bg-black/50 overflow-visible">
                    <AgenticImageCarousel />
                </div>
            </div>
    ...
    <section className="workflow-section relative pt-20 pb-0" id="fluxo">
        <ContainerScroll
            titleComponent={
                <div className="flex flex-col items-center justify-center text-center px-4">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-[0.3em] opacity-40 mb-10">
    ...
    <section className="skills-section pt-4 overflow-visible" id="skills">
        <div className="carousel-integration relative z-40 mb-[-500px] opacity-90 pointer-events-auto overflow-visible">
            <AgenticImageCarousel />
        </div>
                ...
                <div className="brain-features reveal">
                    ...
                    <div className="brain-feature">
                        ...
                        <div>
                            ...
                            <p>Versionamento automático via <AgenticHoverLink previewKey="scripts">github_sync.ps1</AgenticHoverLink> backup e histórico.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="evo-content">
            <div className="evo-timeline reveal">
                ...
                <div className="timeline-step">
                    ...
                    <div className="timeline-info">
                        <h4>Promoção</h4>
                        <p>Se fitness &gt; parent, a nova versão substitui a anterior. O sistema ficou mais forte.</p>
                    </div>
                </div>
                <div className="timeline-step">
        ...
        <div className="anneal-content glass reveal">
            <div className="anneal-left">
                ...
                <ol className="anneal-steps">
                    <li><strong>Detecta</strong> o erro via stack trace estruturado</li>
                    <li><strong>Corrige</strong> o <AgenticHoverLink previewKey="scripts">script</AgenticHoverLink> automaticamente</li>
                    <li><strong>Testa</strong> a solução em ambiente isolado</li>
                    <li><strong>Atualiza</strong> a <AgenticHoverLink previewKey="directives">directiva</AgenticHoverLink> com a nova lição aprendida</li>
